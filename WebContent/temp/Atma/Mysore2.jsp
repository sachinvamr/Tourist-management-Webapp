                    ...
                    <div class="blog_left_sidebar">
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <a href="Tours2.jsp?id1=Mysore.MysorePalace"><img class="card-img rounded-0" src="images/Mysore-palace2.jpg" alt=""></a>
                            </div>

                            <div class="blog_details">
                                <a class="d-inline-block" href="Tours2.jsp?id1=Mysore.MysorePalace">
                                    <h2>Mysore Palace</h2>
                                </a>
                                <ul class="blog-info-link">
                                  <li><a href="#" style="font-size:100%;"><b>Heritage</b></a></li>
                                  <li><a href="#" style="font-size:110%;"><b>Cost: 400</b></a></li>
                                  <li><a href="#" style="font-size:100%;"><b>Number of days: 1</b></a></li>
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <a href="Tours2.jsp?id1=Mysore.Talakad"><img class="card-img rounded-0" src="images/Talakad.jpg" alt=""></a>
                            </div>

                            <div class="blog_details">
                                <a class="d-inline-block" href="Tours2.jsp?id1=Mysore.Talakad">
                                    <h2>Talakad</h2>
                                </a>
                               <ul class="blog-info-link">
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <a href="Tours2.jsp?id1=Mysore.Ranganthittu"><img class="card-img rounded-0" src="images/Ranganthettu.jpg" alt=""></a>
                            </div>

                            <div class="blog_details">
                                <a class="d-inline-block" href="Tours2.jsp?id1=Mysore.Ranganthittu">
                                    <h2>Ranganthettu Bird Sanctuary</h2>
                                </a>
                                <ul class="blog-info-link">
                                  <li><a href="#" style="font-size:100%;"><b>Nature</b></a></li>
                                  <li><a href="#" style="font-size:110%;"><b>Cost: 450</b></a></li>
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <a href="Tours2.jsp?id1=Mysore.Shivanasamudra"><img class="card-img rounded-0" src="images/Shivanasamudra.jpg" alt=""></a>
                            </div>

                            <div class="blog_details">
                                <a class="d-inline-block" href="Tours2.jsp?id1=Mysore.Shivanasamudra">
                                    <h2>Shivanasamudra Falls</h2>
                                </a>
                                <ul class="blog-info-link">
                                  <li><a href="#" style="font-size:100%;"><b>Nature</b></a></li>
                                  <li><a href="#" style="font-size:110%;"><b>Cost: 400</b></a></li>
                    ...
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget post_category_widget">
                            ...
                            <ul class="list cat-list">
                                ...
                                <li>
                                    <a href="Kolkata2.jsp" class="d-flex">
                                        <p>Kolkata</p>
                                    </a>
                                </li>
                            </ul>
