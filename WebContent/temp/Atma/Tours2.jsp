...
<body>
		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				...
				<form action="book" method="get">
					<span
						class="login100-form-title p-b-33"> Details </span>

					<p></p>
					<label for="Start Date">Start Date</label>
					<div class="wrap-input100 rs1 validate-input"
						data-validate="Start Date is required">
						<input class="input100" type="date" name="start"
							placeholder="Start Date"> <span class="focus-input100-1"></span>
				...
				<br>
					...
					<div class="select-form mb-30">
						<div class="select-itms">
							<label for="Cost"> Number of Members:</label>
							<p></p>
					...
					<br>
					<!-- <form action="/action_page.php"> -->
					<label for="Cost"> Mode of Transport:</label>
					<p></p>
					...
					<p>*Transport Charge extra based on mode</p> <br>
					<br> <br>
					<br>
					<!-- <form action="/action_page.php"> -->
					...
					<%
							if (request.getParameter("id1") !=null) {
								session.setAttribute("tourid", (String)request.getParameter("id1"));
							}
							else
							{
					...
					<div class="container-login100-form-btn m-t-20">
						<div class="container-login100-form-btn m-t-20">
							<a href="#" class="login100-form-btn"><input type="submit"
								class="login100-form-btn" name="Submit" value="Submit"></a>
						</div>
					</div>
				</form>
			</div>
	...
	<script src="js/main-tours.js"></script>
