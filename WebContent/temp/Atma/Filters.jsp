		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form action="filter" method="get">
					<span class="login100-form-title p-b-33"> Filters </span> <br>
					<br> <label for="Select">Select the Category:</label>
					<p></p>
					...
					</select> <br> <br> <br> <br> <label for="Cost">Cost:</label>
					<p></p>
					<select name="Cost" id="Cost">
						<option value="100-500">100-500</option>
						<option value="500-1000">500-1000</option>
					</select> <br> <br> <br> <br> <label for="days">Number
						of Days:</label>
					<p></p>
					<select name="days" id="days">
						<option value="<=3"><=3</option>
						<option value=">3">>3</option>
					</select> <br> <br> <br> <br> <label for="rating">Rating:</label>
					<p></p>
					...
					<div class="container-login100-form-btn m-t-20">
						<div class="container-login100-form-btn m-t-20">
							<a href="#" class="login100-form-btn"><input type="submit"
								class="login100-form-btn" name="Apply" value="Apply"></a>
						</div>
					</div>
				</form>
			</div>
