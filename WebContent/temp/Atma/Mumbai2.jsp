                    ...
                    <div class="blog_left_sidebar">
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <a href="Tours2.jsp?id1=Mumbai.GatewayOfIndia"><img class="card-img rounded-0" src="images/mumbai-gate.jpg" alt=""></a>
                            </div>

                            <div class="blog_details">
                                <a class="d-inline-block" href="Tours2.jsp?id1=Mumbai.GatewayOfIndia">
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <a href="Tours2.jsp?id1=Mumbai.ElephantaCaves"><img class="card-img rounded-0" src="images/Elephanta-caves.jpg" alt=""></a>
                            </div>

                            <div class="blog_details">
                                <a class="d-inline-block" href="Tours2.jsp?id1=Mumbai.ElephantaCaves">
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <a href="Tours2.jsp?id1=Mumbai.BandraWorli"><img class="card-img rounded-0" src="images/Bandra-Worli.jpg" alt=""></a>
                            </div>

                            <div class="blog_details">
                                <a class="d-inline-block" href="Tours2.jsp?id1=Mumbai.BandraWorli">
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <a href="Tours2.jsp?id1=Mumbai.ShivajiTerminus"><img class="card-img rounded-0" src="images/Shivaji-terminus.jpg" alt=""></a>
                            </div>

                            <div class="blog_details">
                                <a class="d-inline-block" href="Tours2.jsp?id1=Mumbai.ShivajiTerminus">
                                    <h2>Chhatrapati Shivagi Terminus</h2>
                                </a>
                                <ul class="blog-info-link">
                                  <li><a href="#" style="font-size:100%;"><b>Heritage</b></a></li>
                                  <li><a href="#" style="font-size:110%;"><b>Cost: 500</b></a></li>
